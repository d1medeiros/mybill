...
public class BillController {
    ...
    @GetMapping("/paid")
    public List<Bill> findBillByPaid(@RequestParam String token) {
        User user = decodeToken(token, userService);
        return billAndWalletService.findByPaidBill(user.getWallet());
    }

    @GetMapping("/notpaid")
    public List<Bill> findBillByNotPaid(@RequestParam String token) {
        User user = decodeToken(token, userService);
        return billAndWalletService.findByNotPaidBill(user.getWallet());
    }
